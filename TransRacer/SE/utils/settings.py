...
ATTACKER_ACCOUNTS = ["0xdeadbeefdeadbeefdeadbeefdeadbeefdeadbeef"]#0x2222222222222222222222222222222222222222
# Default gas limit for sending transactions
GAS_LIMIT = 30000000 #4500000
# Default gas price for sending transactions
GAS_PRICE = 10
# Default account balance
ACCOUNT_BALANCE = 100*(10**18)
